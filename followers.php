<?php
	...
	$query = "SELECT * FROM followers WHERE following = :user_name";  
	...
	if(isset($_POST["search"])) 
        {
			$var1= $_POST["var1"];
			$sql = 'SELECT * FROM followers WHERE following LIKE :keyword ORDER BY id DESC ';
...
<div>
     <?php if(empty($var1))
	 {
		 while ($row = $z->fetch()): ?>
	<a><h4>
	  <?php  echo htmlspecialchars($row['follower']);  ?>
